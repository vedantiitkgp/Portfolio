...
I completed my MS in Computer Science at the [University of California, Irvine](https://uci.edu/) in April 2025, specializing in Machine Learning and Natural Language Processing. During my time at UCI, I was funded through Graduate Teaching Assistantships, educating fellow students on Big Data Management concepts including Spark, SQL/NoSQL Databases, and Transaction Management. I also worked as an [ELP Data and Technology Fellow](https://odit.uci.edu/initiatives/elp.php), developing Explainable AI applications for UCI Health, including modular RAG-based clinical trial matching platforms and sustainability analytics dashboards. I volunteered with the ZotBins team, working on efficient image processing architecture for smart waste bins.

During my graduate studies, I completed a Machine Learning internship at [Viasat](https://www.viasat.com/), where I built predictive pipelines for active residential and in-flight network bandwidth estimation using ML forecasting models on AWS.

Currently, I'm working as a Member of Technical Staff at [Articul8 AI](https://articul8.ai/), where I'm part of the Platform Engineering team. I design distributed multi-agent orchestration systems, architect scalable knowledge ingestion pipelines using technologies like Ray, ArangoDB, and Milvus, and work on platform infrastructure and observability across AWS and GCP using Kubernetes, Terraform, and modern GitOps workflows.

My diverse experiences across academia, industry, and research have equipped me with a unique perspective on tackling complex technological challenges. I'm passionate about leveraging my skills in artificial intelligence, distributed systems, and machine learning to drive innovation and create meaningful impact in the field of computer science.
